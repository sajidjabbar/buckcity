...
<!-- Slick Slider -->
<link href="css/termscondition.css" rel="stylesheet">
<!-- Slick Slider -->

<!-- Banner Start here -->
<section class="termscondition-banner universal-banner text-white text-center">
...
<section class="termscondition text-white text-center">
    <div class="container">
        <p>
        ...
        <p>
            ...
            creating a user experience that will (whether we like it or not) be DRIVEN by words. The entire structure of
            the page or app flow is FOR THE WORDS
        </p>
    </div>
</section>
<!-- Privacy Section Start Here -->
